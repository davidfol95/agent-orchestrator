...
export interface ReactionConfig {
  ...
  /** What to do: send message to agent, notify human, auto-merge, run security scan, or close the tracker issue */
  action: "send-to-agent" | "notify" | "auto-merge" | "security-scan" | "close-issue";
